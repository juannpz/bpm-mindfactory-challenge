...
const validationSchema = yup.object({
  ...
  areaId: yup.string().required("Seleccione el área destino"),
});

export default function CrearTramiteInternoPage() {
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            >
              ...
              <Select
                ...
                label="Área Destino"
                onChange={(e: SelectChangeEvent) => formik.setFieldValue("areaId", e.target.value)}
              >
                {areas?.map((a) => (
